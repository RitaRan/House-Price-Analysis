...
df = summaries$coefficients[c("(Intercept)","log(Lot.Area)",
                         ...
                         "poly(Year.Remod.Add,2)2","Bsmt.ExposureGd",
                         "Bsmt.ExposureMn","Bsmt.Full.Bath","Bsmt.Unf.SF",
                         "StreetPave","Full.Bath","Half.Bath","Wood.Deck.SF",
                         "log(Open.Porch.SF + 1)","log(Screen.Porch + 1)"),]
