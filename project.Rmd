...
* Based on the ordered boxplots of `price` vs. `Neighborhood`, we found the two most expensive neighborhoods `` have few properties with extremely high price
...
```{r}
plot(ames_train$Garage.Yr.Blt[!is.na(ames_train$Garage.Yr.Blt)], ames_train$price[!is.na(ames_train$Garage.Yr.Blt)]^0.25)
points(rep(1900,sum(is.na(ames_train$Garage.Yr.Blt))), ames_train$price[is.na(ames_train$Garage.Yr.Blt)]^0.25)
# clean data
