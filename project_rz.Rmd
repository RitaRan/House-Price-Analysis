...
table(ames_train$Electrical)
table(ames_test$Electrical)
...
model1 = lm(log(price) ~ area + Year.Built + Year.Remod.Add + Garage.Cars + Overall.Qual +  Lot.Area + BsmtFin.SF.1 + Overall.Cond + Total.Bsmt.SF + Central.Air + Bsmt.Full.Bath + Screen.Porch + Kitchen.Qual , data=ames_train[,-1])
...
table(ames_train$Garage.Qual)
table(ames_test$Garage.Qual)
```
