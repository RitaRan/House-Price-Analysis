...
model1 = lm(log(price) ~ area + MS.SubClass + Year.Built + Year.Remod.Add + Garage.Cars + Overall.Qual +  Lot.Area + BsmtFin.SF.1 + Overall.Cond + Total.Bsmt.SF + Central.Air + Bsmt.Full.Bath + Screen.Porch + Kitchen.AbvGr + Enclosed.Porch, data=ames_train[,-1])
...
model1 = update(bestforward, .~.-Kitchen.Qual-Bath-Garage.Cond-Garage.Qual-Heating.QC-Condition.2-Electrical)
summary(bestforward)
summary(model1)
