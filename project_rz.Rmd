...
train = sample(1:nrow(ames_train),nrow(ames_train)*0.8)
ames_train.train = ames_train[train,]
ames_train.test = ames_train[-train,]
ames_train.train = clean_data(ames_train.train)
ames_train.test = clean_data(ames_train.test)
