...
model2 =gbm(price~.,data =ames_train,n.trees =5000, interaction.depth =15)
# replace model1 with model2
predictions = as.data.frame(predict(model2, newdata=ames_test, interval = "pred",n.trees =5000))
predictions$PID = ames_test$PID
save(predictions, file="predict.Rdata")
```
...
# replace model1 with model2
predictions = as.data.frame(predict(model2, newdata=ames_validation, interval = "pred",n.trees =5000))
